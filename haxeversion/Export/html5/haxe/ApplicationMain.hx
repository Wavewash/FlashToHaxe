...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlashToHaxeDemo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FlashToHaxeDemo", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "14";
		app.meta["company"] = "None";
		app.meta["file"] = "FlashToHaxeDemo";
		app.meta["name"] = "FlashToHaxeDemo";
		app.meta["packageName"] = "org.none";
